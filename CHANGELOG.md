...
## [2.74.0](https://github.com/bhardwajRahul/emailengine/compare/v2.73.1...v2.74.0) (2026-07-23)


### Features

* accept threadId on the submit reference object ([b1b3dc7](https://github.com/bhardwajRahul/emailengine/commit/b1b3dc73ec5870a7a8ab9f0844055822ad046d2a))
...
* add audit logging for admin authentication events ([0ea15d4](https://github.com/bhardwajRahul/emailengine/commit/0ea15d444ed589cd872b11190d07f7751f5cf54b))
* add configurable Gmail Pub/Sub subscription TTL setting ([ca33e7f](https://github.com/bhardwajRahul/emailengine/commit/ca33e7f9101b3375d7e0001cdbe1d7a41a9442d3))
* add direct account registration for email service account apps ([6602b2e](https://github.com/bhardwajRahul/emailengine/commit/6602b2ee3f851bcfec00b34e70756007763f5490))
...
* add Gmail Subscriptions tab to OAuth config page ([3bd30bf](https://github.com/bhardwajRahul/emailengine/commit/3bd30bf0bbc26600eae40d42e95ef7976257e4f2))
...
* add OAuth2 app "Verify setup" diagnostic ([cba9f58](https://github.com/bhardwajRahul/emailengine/commit/cba9f58bc58a434c6156cd2e55fee655336a4cf4))
...
* add Outlook Service (client_credentials) provider for app-only Microsoft 365 access ([#587](https://github.com/bhardwajRahul/emailengine/issues/587)) ([5f906cd](https://github.com/bhardwajRahul/emailengine/commit/5f906cd540564afe2dc2024b4e17c2d5d9483ed2))
* add passkey (WebAuthn) authentication for admin login ([a39b362](https://github.com/bhardwajRahul/emailengine/commit/a39b362152597bcc864307cd7c46cdc78a3808e6))
* add Workload Identity Federation for Gmail service accounts ([1879c5a](https://github.com/bhardwajRahul/emailengine/commit/1879c5aaf30ccff1879e74d28b0c76e25b3d77ae))
...
* always use persistent sessions and support remember-me for passkey login ([6a6fc74](https://github.com/bhardwajRahul/emailengine/commit/6a6fc74748f92372e135e88478a9fa0f83cf690f))
...
* flag nested message/rfc822 attachments with encodedInMessage property ([7e51024](https://github.com/bhardwajRahul/emailengine/commit/7e51024c690235e36cbbf8297939f0a41002b05e))
* handle MS Graph 'missed' lifecycle event for Outlook notification recovery ([d55f48c](https://github.com/bhardwajRahul/emailengine/commit/d55f48c9a183f9e0108801563b1085c176dbeb06))
* lock Gmail auth method display after app creation ([6ba16c2](https://github.com/bhardwajRahul/emailengine/commit/6ba16c2fbca571d500b21be776dbf5eb76fcf8a1))
...
* revoke upstream OAuth2 grant on account delete via ?revoke=true ([2a8c8fa](https://github.com/bhardwajRahul/emailengine/commit/2a8c8faf7f63acfab31998fb067289d4c6bd2f09))
* revoke upstream OAuth2 grant on account delete via ?revoke=true ([15bc43a](https://github.com/bhardwajRahul/emailengine/commit/15bc43ae0f8dbf70021a1e13de55c80ec7271a15))
* show curl example for service account OAuth2 apps ([4ab5eda](https://github.com/bhardwajRahul/emailengine/commit/4ab5edabf64373e8b2dd4bb0ea658847d40ba904))
* show human-readable missing scopes on OAuth scope error page ([4ee2365](https://github.com/bhardwajRahul/emailengine/commit/4ee2365449e3cbece6f4a83d540ae63c18464535))
...
* use tabs for Gmail auth method and lock it after creation ([6c74521](https://github.com/bhardwajRahul/emailengine/commit/6c7452138c257ecf0667aa9b44d1fa91186e2302))
...
* add .catch() to fire-and-forget setMeta and track error fingerprints ([672a03e](https://github.com/bhardwajRahul/emailengine/commit/672a03e2524bcaa26c4d3c908fa828f4e636999b))
* add IMAP fetch retry timeout and harden passkey registration ([3a1b61b](https://github.com/bhardwajRahul/emailengine/commit/3a1b61b00e916c308cae5e7493a2207164d9d45f))
* add lock to del() to prevent race with ensurePubsub, fix pubSubApp cleanup ([27f2bdd](https://github.com/bhardwajRahul/emailengine/commit/27f2bdd4a9e3d7e913e7f4bed96084a278bb6312))
...
* always notify webhook workers when Pub/Sub app config changes ([e9f276a](https://github.com/bhardwajRahul/emailengine/commit/e9f276ab528ad384bcbf5c370a0d0cb22e084cc5))
...
* auto-recover expired Gmail Pub/Sub subscriptions and expose status via API ([7961ceb](https://github.com/bhardwajRahul/emailengine/commit/7961ceb8ce81688e5c3bb435a6c33ed3882afd7b))
...
* avoid redundant Redis call and concurrent backfill races in Pub/Sub setup ([05b02af](https://github.com/bhardwajRahul/emailengine/commit/05b02afc1c14de1b8fa4e272d26da2056280731a))
...
* broaden Pub/Sub notification condition in oauth-routes.js ([cbe1380](https://github.com/bhardwajRahul/emailengine/commit/cbe13800ab9460c41f5dcdcd4d7ae50f8e5e75e3))
* broken Handlebars script tag, Okta session fall-through, login rate limiting, and passkey schema validation ([01e5721](https://github.com/bhardwajRahul/emailengine/commit/01e5721ee02ad66ce9c30b58c406988b1cfd1ae3))
...
* clean up Pub/Sub Redis keys on deletion, refresh stale instances, and localize UI labels ([3b35fa1](https://github.com/bhardwajRahul/emailengine/commit/3b35fa19a6a8024a60d2ed21e9fcd69fda349481))
* clear passkey credentials on CLI password reset and document remember-me behavior ([35f7f00](https://github.com/bhardwajRahul/emailengine/commit/35f7f00970b7e7f3a514d2ea0d97fce5320f6e1b))
* clear stale pubSubFlag after restart and consolidate backfill push ([f67961f](https://github.com/bhardwajRahul/emailengine/commit/f67961fbc590aa586ef40b65c2189b5dab4d89c0))
...
* clearer error when loading wrong file into WIF config field ([40686d4](https://github.com/bhardwajRahul/emailengine/commit/40686d409229347193c1e153e9e47f98b5de86dc))
* close command client proactively after subconnection setup ([02d3687](https://github.com/bhardwajRahul/emailengine/commit/02d36874d8533beabe5ad0fba978851b3791cbb5))
...
* correct pubSubApp property name in del() and add cleanup tests ([016ae0a](https://github.com/bhardwajRahul/emailengine/commit/016ae0a98bc52eeee2bd1ec4f4d0ed58e92c507d))
* correct translation errors and remove EmailEngine branding from OAuth scope error ([9284ddd](https://github.com/bhardwajRahul/emailengine/commit/9284ddd1e28e40fd24abeea7296636b21c4b3878))
* correct typo in Pub/Sub schema version log message ([2cc8e08](https://github.com/bhardwajRahul/emailengine/commit/2cc8e085463ed550e341b027e592b5351784182e))
...
* detect IMAP drift that landed during an in-progress sync ([8fece8a](https://github.com/bhardwajRahul/emailengine/commit/8fece8ad6f3acb5e7391da7a9740279099f62177))
...
* do not prefill login username field ([59835a8](https://github.com/bhardwajRahul/emailengine/commit/59835a84f3e2a01c6461f29ecb80763dc4a42fe2))
...
* eliminate redundant Redis ops in Pub/Sub pull loop and backfill ([c8ebe39](https://github.com/bhardwajRahul/emailengine/commit/c8ebe393744eee46c3d19b5be413badd8ab315d6))
...
* fix export TTL expiration, cancellation cleanup, and expose truncated field ([019c05c](https://github.com/bhardwajRahul/emailengine/commit/019c05c941842ae28668711e8f5c2e8a85d3b84b))
* fix lifecycle event races, lock TTL, and stale clearExisting in MS Graph subscriptions ([3f3cbac](https://github.com/bhardwajRahul/emailengine/commit/3f3cbac843c4c221644492855d7c1beb41cd1da0))
* fix missing renewal retry, clock-skew gap, and incomplete pipeline error check ([8a8b5b6](https://github.com/bhardwajRahul/emailengine/commit/8a8b5b68feb3edd7c984707a85ddb6d146739020))
* fix off-by-one retry cap and simplify MS Graph subscription code ([aa9afbc](https://github.com/bhardwajRahul/emailengine/commit/aa9afbc5aea20d1bf775e59dbfd82842c4f8b701))
* fix Pub/Sub deletion race, add 429 handling, batch ACKs, and lock ensurePubsub ([744c354](https://github.com/bhardwajRahul/emailengine/commit/744c354a062f63eedcec8de1a324a5d13519b9a7))
* fix retry boundary, lock races, and dropped lifecycle events in MS Graph subscriptions ([d62741d](https://github.com/bhardwajRahul/emailengine/commit/d62741d2a2aafc47d831482b71ff24fa4c9d1883))
* fix silent 401/403 error suppression, floating promise, and recovery loop in Pub/Sub ([406211c](https://github.com/bhardwajRahul/emailengine/commit/406211cbd62f7d3f1b811fbec81767f319219c63))
* fix stale subscription state blocking recovery and retry count persisting across reconnects ([60b77d5](https://github.com/bhardwajRahul/emailengine/commit/60b77d5d7574abf728c5e1f015c0cecddd5d9fdd))
* fix subscription loss on subscriptionRemoved, lifecycle webhook timeout, and retry gaps ([62988ab](https://github.com/bhardwajRahul/emailengine/commit/62988ab3b690ed98583fa01557a9c4145427e3ae))
* flag WIF support in the gmailService form intro ([61fab27](https://github.com/bhardwajRahul/emailengine/commit/61fab2720aa2f289a944ae99629bc47ada8e9e09))
* force-exit external-account-signer test to unblock CI ([f4a1e4e](https://github.com/bhardwajRahul/emailengine/commit/f4a1e4e50ac890d7771e38181a9488837c67757a))
...
* guard fire-and-forget setMeta calls and add Pub/Sub graceful shutdown ([45f7b64](https://github.com/bhardwajRahul/emailengine/commit/45f7b64d7692b220ff14ec0e1c0e9deea84731de))
...
* guard null imapClient dereferences during async operations ([671bcee](https://github.com/bhardwajRahul/emailengine/commit/671bcee4e81c7c0d6421617c3e25ec6906cb1abb))
* guard releaseLock against undefined, add 429 handling to Pub/Sub deletion ([d67ebe1](https://github.com/bhardwajRahul/emailengine/commit/d67ebe138ca9663796eacc5a1c6b5b73e721e6c4))
...
* handle non-numeric error codes from Microsoft Graph in OAuth callback ([#580](https://github.com/bhardwajRahul/emailengine/issues/580)) ([89fd9f7](https://github.com/bhardwajRahul/emailengine/commit/89fd9f74db0cb32d4980b57b6c623e5d98b426a8))
* handle TimeoutError from AbortSignal.timeout in Pub/Sub pull loop ([c0e3036](https://github.com/bhardwajRahul/emailengine/commit/c0e303641e4eb9f6cdca3c584861052b2bd91148))
* handle undici HeadersTimeoutError as transient in Pub/Sub and OAuth2 paths ([8b3b698](https://github.com/bhardwajRahul/emailengine/commit/8b3b69880ab09119df4ca377d085db261eae2763))
...
* harden MS Graph subscription lifecycle, locking, cleanup, and error recovery ([8210056](https://github.com/bhardwajRahul/emailengine/commit/8210056f7e7b00977fb5487323ff1b8f9f4b7a99))
...
* harden passkey auth, IMAP sync error handling, and login form UX ([c16b983](https://github.com/bhardwajRahul/emailengine/commit/c16b98312f35d87fd8b21974a7eb7eca6459cc3b))
* harden passkey authentication with validation, rate limits, and audit logging ([75dd289](https://github.com/bhardwajRahul/emailengine/commit/75dd289940e7345fa56246c90ff6bc8d01694e6c))
* harden Pub/Sub deletion, IAM policy, and worker timeout cleanup ([0be7c3e](https://github.com/bhardwajRahul/emailengine/commit/0be7c3eb04f3381306284e1e3790f7c3cc28cb5a))
* harden Pub/Sub pull loop resilience and fix projectId typo ([8124328](https://github.com/bhardwajRahul/emailengine/commit/81243287f339b5fe40cddd0e1d127514d2e11f4a))
* harden Pub/Sub pull loop, message ACK, list pairing, and shutdown cleanup ([9e9775f](https://github.com/bhardwajRahul/emailengine/commit/9e9775f6df97af42bdb8b799c2345a4564f8a77a))
* harden Pub/Sub pull loop, worker coordination, and OAuth app lifecycle ([529b705](https://github.com/bhardwajRahul/emailengine/commit/529b7055dd4aeb0b1d80fabff3f139cf23f00252))
* harden Pub/Sub shutdown, loop scheduling, and abort lifecycle ([71b3ab4](https://github.com/bhardwajRahul/emailengine/commit/71b3ab4625fa3304ae7a4413a3b0a64276948d7f))
* harden Pub/Sub shutdown, transient error handling, and input validation ([cfc6e0b](https://github.com/bhardwajRahul/emailengine/commit/cfc6e0bb73902600b6eecc6bc955af85f06d9b0f))
* harden static file route with path confinement and pkg-only guard ([19cd5f6](https://github.com/bhardwajRahul/emailengine/commit/19cd5f632baa7fb37f5d639f234c5374b371ab93))
...
* improve translation quality across 6 languages ([d7d338e](https://github.com/bhardwajRahul/emailengine/commit/d7d338e761152909d4c2ca4732fafb60529413ab))
* include ESM [@csstools](https://github.com/csstools) packages as pkg assets ([df9f6d2](https://github.com/bhardwajRahul/emailengine/commit/df9f6d286b0fc2819edf0bf2f179dc0d6d2ce0d5))
* include failed jobs in /v1/outbox response ([b393676](https://github.com/bhardwajRahul/emailengine/commit/b393676f2f877046d27b06d518a03dd256d5b7d9))
...
* let npm run gettext parse object spread and drop non-ASCII from template ([195ce60](https://github.com/bhardwajRahul/emailengine/commit/195ce601db50f394164ca05e2efb6de4b784a77a))
...
* localize error page strings using translation helper ([609ebb9](https://github.com/bhardwajRahul/emailengine/commit/609ebb94d1e662ac661f7efe22f6608d7823fb85))
...
* login page divider logic, select() log level, and missing trailing newlines ([97ff93e](https://github.com/bhardwajRahul/emailengine/commit/97ff93e2cc6c865a0f597a42a124e0abb140e34a))
* mask externalAccount in OAuth2 app API responses ([fac18bf](https://github.com/bhardwajRahul/emailengine/commit/fac18bfdc11d5d252e0d93980aad7c90d92b246f))
...
* move pubsub status from unauthenticated /health to GET /v1/pubsub/status ([f6597ad](https://github.com/bhardwajRahul/emailengine/commit/f6597addff4de1c23fbd88964702bc2425f14d0c))
* normalize copy across login and security pages ([60e132a](https://github.com/bhardwajRahul/emailengine/commit/60e132a9e4e8f96fc621b4b454f95896fb4d48c1))
* normalize sign-in/sign-out copy to sentence case ([1ccfb16](https://github.com/bhardwajRahul/emailengine/commit/1ccfb167a674d887af0ac2db8df3ff434f23e5bb))
...
* per-IP passkey rate limiting and credential ownership check ([2455cbe](https://github.com/bhardwajRahul/emailengine/commit/2455cbe9d6af5d6eff8ae81ecc335b6820bfc904))
* pin subdependency to avoid installing unsupported version ([045b8ce](https://github.com/bhardwajRahul/emailengine/commit/045b8ce1a28c9cf9eecb26723589c5dcb4a28c21))
* pin undici to 7.25.0 for Node 20 compatibility ([3fa80db](https://github.com/bhardwajRahul/emailengine/commit/3fa80db4d64d6fe089fa3a1a0e700a188aeb74f7))
* pkg config options must be a string array ([6c4702d](https://github.com/bhardwajRahul/emailengine/commit/6c4702dbc85171a2987b8cfb6e5a3dc3d656a99d))
...
* prefer refresh token and skip gmailService when revoking on delete ([e0dbea8](https://github.com/bhardwajRahul/emailengine/commit/e0dbea8a4cd4804bf64d50523c8a1152c2119e26))
* prevent EISDIR crash on /static directory requests ([5b9c2db](https://github.com/bhardwajRahul/emailengine/commit/5b9c2db2d3e8f46c55ef0dc7343b7fb730e52414))
* prevent EISDIR crash on static subdirectory requests in pkg ([4d5ef81](https://github.com/bhardwajRahul/emailengine/commit/4d5ef81679e4fd7f5e8a55a260f2c29f99938ba4))
...
* prevent IMAP worker crash on ImapFlow unhandled rejection during IDLE recovery ([86ebb02](https://github.com/bhardwajRahul/emailengine/commit/86ebb02c321ffa758966af1957509c10e20a35fc))
* prevent infinite loop and add retry backoff in account assignment ([f8b9e53](https://github.com/bhardwajRahul/emailengine/commit/f8b9e533a821d1c34a869270fa489437ac80da93))
* prevent message event loss during IMAP sync under heavy load ([ceb139b](https://github.com/bhardwajRahul/emailengine/commit/ceb139b825eaf7fc06bf1c88b9bcc89824abbcdb))
* prevent null dereference crash in getImapConnection during connection drops ([6a356fd](https://github.com/bhardwajRahul/emailengine/commit/6a356fd20e1412a070c26c093108c4ea2a722a5c))
* prevent open redirects via next parameter and require password for passkey registration ([0e7f52a](https://github.com/bhardwajRahul/emailengine/commit/0e7f52ada9687234682027ecb93e81515fcb9dbb))
* prevent oscillating recovery loop for Pub/Sub apps missing googleProjectId ([8bdbc39](https://github.com/bhardwajRahul/emailengine/commit/8bdbc39c790b7097b02459b558328c18584585a2))
...
* prevent permanently lost accounts after worker crashes ([3deabb5](https://github.com/bhardwajRahul/emailengine/commit/3deabb55b195601bf0c14d248257cc8a4aac76d2))
...
* prevent transient network errors during OAuth2 token refresh from being misclassified as auth failures ([38fa212](https://github.com/bhardwajRahul/emailengine/commit/38fa212092847b727ac1d02541103c032a983dc7))
* prevent unhandled promise rejections during mailbox sync ([e6174de](https://github.com/bhardwajRahul/emailengine/commit/e6174defbf1c94f54ac7cbcb45eaa9e5c547926e))
...
* reduce Pub/Sub recovery log noise and respect backoff delay ([63cd78f](https://github.com/bhardwajRahul/emailengine/commit/63cd78fcfd0c12934e488f6936109653371f0899))
...
* reject OAuth2 grants with missing Google granular consent scopes ([3f277d1](https://github.com/bhardwajRahul/emailengine/commit/3f277d1428e4a861752eb18b5d74279afefd1efa))
* relax cross-folder assertion in Graph API parentFolderId test ([770279d](https://github.com/bhardwajRahul/emailengine/commit/770279ded669efdc5d6a2c33d05290daf91251ea))
...
* remove dead circuit breaker code from IMAP and webhooks workers ([da9295b](https://github.com/bhardwajRahul/emailengine/commit/da9295b951d20a5817116195689dd3c964b3d996))
* remove dead redirectToSlash option from static directory handler ([f90339a](https://github.com/bhardwajRahul/emailengine/commit/f90339a663913f47a6d1878225633a4f7cb4ac7e))
* remove password hash from error logs and update passkey description copy ([d28dd16](https://github.com/bhardwajRahul/emailengine/commit/d28dd16e61fc84d0800546c4f33d4535f52e2a22))
* remove Pub/Sub circuit breaker, fix 401/403 recovery handling ([b7017f3](https://github.com/bhardwajRahul/emailengine/commit/b7017f34478dbb3bcedfb9a1e098a8a45cb0f83d))
* remove unnecessary min-height from login form ([f16940d](https://github.com/bhardwajRahul/emailengine/commit/f16940d9957df114ce0ff4240107a82619a58705))
* reorder OAuth app deletion to prevent pull-loop gap, add startLoop tests ([129f96c](https://github.com/bhardwajRahul/emailengine/commit/129f96c99ff9ff2552fa1c1962b1e0a652b8837e))
* replace BigInt literal with constructor for gettext parser compatibility ([119ba69](https://github.com/bhardwajRahul/emailengine/commit/119ba6919768ff6d22161e6c7884b8020fab37f5))
* replace custom Redis locks with ioredfour in Outlook subscription code ([019eaa1](https://github.com/bhardwajRahul/emailengine/commit/019eaa1f26be504d127cb6c8a05dfe50d8a47b71))
* replace spread syntax with Object.assign in tools.js for gettext parser compatibility ([02ecc60](https://github.com/bhardwajRahul/emailengine/commit/02ecc60071c2a798eb6aae32ee6cdfe5a43933b2))
...
* resolve ESLint 10 lint errors ([7d397f6](https://github.com/bhardwajRahul/emailengine/commit/7d397f6d87c87c4a8bb456a52c9db264c7c14243))
* resolve HTTP proxy feature issues ([750619d](https://github.com/bhardwajRahul/emailengine/commit/750619d0145b60706dedec1d39ae94f9a2457ab7))
* resolve lint errors, fix TTL null guard, and extract Pub/Sub constants ([4949431](https://github.com/bhardwajRahul/emailengine/commit/4949431c8e05f06c5aafc3dfe93876ea8a2875b9))
* resolve livelock, timeout, and state corruption in MS Graph subscription lifecycle ([745334e](https://github.com/bhardwajRahul/emailengine/commit/745334e8c55fcf4b0b3fc6adef2b37f6cf9aea61))
* resolve OAuth2 provider for delegated Outlook accounts ([f35c816](https://github.com/bhardwajRahul/emailengine/commit/f35c816e3149eeaa568d86c06fa6783c649c54c5))
...
* restore IMAP XOAUTH2 path for gmailService accounts ([d2ebe9b](https://github.com/bhardwajRahul/emailengine/commit/d2ebe9b3c19cd0bcaaf0fa17d40148f79dd7cd2b))
...
* retry transient errors during Pub/Sub resource deletion and log dropped messages ([b9d9de5](https://github.com/bhardwajRahul/emailengine/commit/b9d9de56a50b37e0163ea4e9a954d65bc305004c))
...
* retry transient network errors in Gmail and Outlook API request functions ([08ea0da](https://github.com/bhardwajRahul/emailengine/commit/08ea0daecaec73c58a91ac07df5d0f0ffc083a2f))
...
* right-align the service account Add account button ([c6f77b9](https://github.com/bhardwajRahul/emailengine/commit/c6f77b9777fb1cb9b1449662d05d4887e36a6ad8))
...
* show OAuth apps with failed Pub/Sub setup in subscriptions list ([14124cd](https://github.com/bhardwajRahul/emailengine/commit/14124cd29baf107f1f82dff48695bc51cae4fd97))
...
* stop Pub/Sub instances on OAuth2 app deletion and harden lifecycle ([bc0ff75](https://github.com/bhardwajRahul/emailengine/commit/bc0ff758cea8d8713485e3a28e81b16ee56d1dc7))
...
* surface TTL reconciliation failures to operators via ttlWarning meta flag ([6e5d5c5](https://github.com/bhardwajRahul/emailengine/commit/6e5d5c5a97fb9aaff2662f3fe2f90c8226359b4a))
* switch pkg targets from node22 to node24 to fix Windows builds ([12522a7](https://github.com/bhardwajRahul/emailengine/commit/12522a7b92d72684af49cd70c1c6d4bcafe1d4af))
...
* throw instead of silent return in select() null guard, revert redundant optional chaining ([cb7db50](https://github.com/bhardwajRahul/emailengine/commit/cb7db5024e0b00f8a773328dd5e0009067bed0b6))
...
* treat DNS errors as transient in Google Pub/Sub polling loop ([ec33673](https://github.com/bhardwajRahul/emailengine/commit/ec33673b47242fd7156b4641c9c4924a33eaf9e5))
...
* update client-side Handlebars to 4.7.9 and harden passkey input validation ([882891c](https://github.com/bhardwajRahul/emailengine/commit/882891c36ed3704d96ccf227e682e152f5395036))
...
* update imapflow to 1.2.15 to fix unhandled rejection crashes ([494a3f8](https://github.com/bhardwajRahul/emailengine/commit/494a3f8cd9e71bc1fc1683bea2fc92474cb33206))
* update tests for getCurrentListing null guard changes ([a644f9c](https://github.com/bhardwajRahul/emailengine/commit/a644f9c1c3f3e4cbce388e43bfa319f11f4a469c))
* upgrade handlebars to 4.7.9 to resolve prototype pollution vulnerability ([452f5f5](https://github.com/bhardwajRahul/emailengine/commit/452f5f54f4007e4b765e18861ce01cde312cc83c))
...
* use STATUS instead of NOOP as keepalive for 163.com IMAP ([3b3516f](https://github.com/bhardwajRahul/emailengine/commit/3b3516feb14e64bab5ac586378237f2160cdf010))
* use template literals for translated strings in showErrorPopup ([b56fd1f](https://github.com/bhardwajRahul/emailengine/commit/b56fd1fa7612b4cf2b7e99cbd78d7447b89c03c6))
* validate fallback status codes in resolveOAuthErrorStatus ([d2b49e3](https://github.com/bhardwajRahul/emailengine/commit/d2b49e3ad0c78c17a8aee6f1679fa3597d85ca4b))
...
* optimize mailbox listing for accounts with many folders ([a39e5f7](https://github.com/bhardwajRahul/emailengine/commit/a39e5f7b02156fc73ab44d1ca4f6e977e4290312))
