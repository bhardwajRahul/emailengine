...
## [2.80.0](https://github.com/bhardwajRahul/emailengine/compare/v2.79.8...v2.80.0) (2026-09-04)
...
* add anonymized feature beacon to license validation ([954d92a](https://github.com/bhardwajRahul/emailengine/commit/954d92a9d8e7c5fff6f1b8c711dfd228f556387a))
...
* adopt pre-existing Gmail Pub/Sub resources with ownership tracking ([fe43fad](https://github.com/bhardwajRahul/emailengine/commit/fe43fadad624025a56139382428256eb810f9e08))
* allow enabling Sentry error reporting from the admin UI ([a4076a4](https://github.com/bhardwajRahul/emailengine/commit/a4076a4fa6658ccc998f9bfe35dddf015cd12b09))
...
* disable deprecated Document Store by default behind a feature gate ([8790f75](https://github.com/bhardwajRahul/emailengine/commit/8790f7538ba2ee8d6ec73d1f3bbc221c2f54f0fe))
...
* replace Bugsnag with self-hosted Sentry for error tracking ([62de831](https://github.com/bhardwajRahul/emailengine/commit/62de831a2911da9b649fe693547ba09d70e2e481))
...
* tag Sentry error reports with instance id and license key ([2e9683f](https://github.com/bhardwajRahul/emailengine/commit/2e9683f27d54ff8fa7ba3f6f4453866fd135f173))
...
* constant-time MS Graph clientState check and escape unsubscribe email ([3def225](https://github.com/bhardwajRahul/emailengine/commit/3def225ab1d598dec4f0b44443ff842295736039))
* defer export worker job consumption until startup recovery completes ([a21b0a5](https://github.com/bhardwajRahul/emailengine/commit/a21b0a50fdb98d13a2227a020069129d23fe225b))
...
* escape Redis glob metacharacters in account-scoped SCAN patterns ([603d9db](https://github.com/bhardwajRahul/emailengine/commit/603d9dbce9c4e21b390e10dc7499f2cc5989c875))
* escape untrusted email fields in message browser to prevent stored XSS ([1159cc1](https://github.com/bhardwajRahul/emailengine/commit/1159cc193a98eb972454a5ae61ec01d7df77f06a))
...
* fail export when a folder cannot be indexed ([36c9c9d](https://github.com/bhardwajRahul/emailengine/commit/36c9c9d536540cd5a61b16b69af5e8e84c194ee6))
* filter transient fetch failures from Sentry and retry DNS errors ([883b9b4](https://github.com/bhardwajRahul/emailengine/commit/883b9b487e3580c5b1240d28cd519d190c402b47))
* gate hosted auth form with a single-use nonce and probe cap, harden serviceSecret ([7ea4ff7](https://github.com/bhardwajRahul/emailengine/commit/7ea4ff7e6ca4d9239201f556b24ebd9cf8ab8250))
...
* harden hosted authentication form (SSRF gate, fail-closed HMAC, XSS) ([4267df7](https://github.com/bhardwajRahul/emailengine/commit/4267df7fd0252aa84ff1d257846126a8f943bf1a))
...
* HTML-escape json Handlebars helper to prevent stored XSS in error logs ([af2c153](https://github.com/bhardwajRahul/emailengine/commit/af2c153eb4d7de06b2730da6fdeb17bbe868472b))
...
* log expected API client errors (4xx) at warn instead of error ([c51e347](https://github.com/bhardwajRahul/emailengine/commit/c51e3476e346f321af845905a89141bf07a83421))
...
* reconnect error-state accounts after OAuth re-auth via create() ([77cee1e](https://github.com/bhardwajRahul/emailengine/commit/77cee1eb1916fbd6582cfcf931023d53f6cc8abf))
...
* resolve code review findings in Gmail bulk ops, exports, webhooks, and schemas ([f0ddb46](https://github.com/bhardwajRahul/emailengine/commit/f0ddb4631fb924ddb93e0a99d0e20bc9f0cc8ee2))
...
* resume sync after OAuth re-auth and enable Run sync for Gmail/Outlook ([f3bef82](https://github.com/bhardwajRahul/emailengine/commit/f3bef823ee90cd6fcf90b95fadcb6f2730657441))
...
* retry transient errors in API-account batch export path ([6cba7c7](https://github.com/bhardwajRahul/emailengine/commit/6cba7c72658a037f68867cf2464f7d3420a79507))
...
* stop logging the MS Graph access token on HTTP 401 ([f2f0300](https://github.com/bhardwajRahul/emailengine/commit/f2f03008cbcbaba8b7c2ff9c043ede7930c5c4ef))
...
* translate OAuth scope error page across 6 languages ([4ae1919](https://github.com/bhardwajRahul/emailengine/commit/4ae19199fe628f8a4f7177d53db1f05167077e3e))
...
* update dependencies (@postalsys/ee-client 1.3.2, nodemailer 9.0.3, bullmq 5.79.2, @sentry/node 10.63.0, [@bull-board](https://github.com/bull-board) 8.0.2) ([b954f67](https://github.com/bhardwajRahul/emailengine/commit/b954f67e1250d8a0029d355a5a8c6fc9d7f00e8e))
* update dependencies (email-text-tools 2.4.10, email-ai-tools 1.13.10) ([73df05c](https://github.com/bhardwajRahul/emailengine/commit/73df05c02db79fc47623ee41e27a315952c289b1))
* update dependencies (libmime 5.4.0, mailparser 3.9.12, imapflow 1.4.3, email-ai-tools 1.13.9) ([8c999d8](https://github.com/bhardwajRahul/emailengine/commit/8c999d8c5e6b550c6d3a28fd4ec118c48d095901))
* upgrade joi to 17.13.4 and @postalsys/certs to 1.0.15 (GHSA-q7cg-457f-vx79) ([6ec77e5](https://github.com/bhardwajRahul/emailengine/commit/6ec77e50b288b14550cd09b724f5aab59d17ced4))
* use constant-time comparison for secret and MAC checks ([453caf3](https://github.com/bhardwajRahul/emailengine/commit/453caf3ac01e58248a3a7019aa4ec3c2179b3abc))
* verify HMAC signature on the human-facing unsubscribe routes ([e30be83](https://github.com/bhardwajRahul/emailengine/commit/e30be836a71bc7e96baee19e5b019da5b0de40fa))
