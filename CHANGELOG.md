...
## [2.81.0](https://github.com/bhardwajRahul/emailengine/compare/v2.80.1...v2.81.0) (2026-09-12)
...
* bump imapflow to 1.4.4 (dedupe nodemailer/iconv-lite) ([5acc8cd](https://github.com/bhardwajRahul/emailengine/commit/5acc8cd99f9179fabb8d8486cf23b0558e4514bf))
* bump imapflow/bullmq/bull-board/sentry-node/eerawlog/prettier ([8f7b6bf](https://github.com/bhardwajRahul/emailengine/commit/8f7b6bf21eae70b1f3c8e0856a6c0f0a0d641317))
* bump imapflow/mailparser/mailsplit/email-ai-tools (collapse iconv-lite) ([51dcffb](https://github.com/bhardwajRahul/emailengine/commit/51dcffb3ff0f22f9b9634d078e58b35aaf7a0312))
* bump libmime/mailparser/smtp-server/pubface (uniform nodemailer) ([eee89bb](https://github.com/bhardwajRahul/emailengine/commit/eee89bb716655519c72fb922849272c1058cbc9a))
...
* clear the connecting flag if loading account data fails during reconnect ([8d82167](https://github.com/bhardwajRahul/emailengine/commit/8d8216730f809eebdc8a0762e38f93f0084de038))
...
* ignore \NonExistent folders in mailbox listing ([7ec96cf](https://github.com/bhardwajRahul/emailengine/commit/7ec96cfaaf5425c16479151e66ef3285c854b49a))
...
* override grunt's transitive js-yaml to 3.15.0 (GHSA-h67p-54hq-rp68) ([024a923](https://github.com/bhardwajRahul/emailengine/commit/024a923de3ff2a880e79c7ddbf34bbc058fcbea3))
...
* process refreshed folder listings so new folders emit mailboxNew ([247c325](https://github.com/bhardwajRahul/emailengine/commit/247c325cc71f1842cc8083c7fd025792217c77d8))
...
* refresh folder listing when a listed mailbox is missing on SELECT ([1e54d32](https://github.com/bhardwajRahul/emailengine/commit/1e54d32c1c74cb1f6d3d085a75d5b5ecc1cf5ff2))
...
* reset IMAP reconnection backoff only after a successful sync ([7138dab](https://github.com/bhardwajRahul/emailengine/commit/7138dabab866483818440478d3584a46dfc8de12))
* reset subconnection backoff only after the monitored mailbox is opened ([f2bf297](https://github.com/bhardwajRahul/emailengine/commit/f2bf297883c38f4d1f61197ae75bdd7ae3976a53))
...
* skip mailboxes that can not be selected during account sync ([eaf09c1](https://github.com/bhardwajRahul/emailengine/commit/eaf09c1700eca77e27fada20371bad193e0665c8))
...
* update connection tracking when replacing a previous IMAP client ([8e143c2](https://github.com/bhardwajRahul/emailengine/commit/8e143c281d03d3d226e65eaae32eab96b1db0671))
