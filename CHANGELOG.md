...
## [2.71.0](https://github.com/bhardwajRahul/emailengine/compare/v2.70.0...v2.71.0) (2026-06-15)
...
* add AES-256-GCM encryption at rest for export files ([4f67269](https://github.com/bhardwajRahul/emailengine/commit/4f6726915bd40087c0f447a7f2cb36943e8a849a))
...
* Add bounce message classification using ML model ([e337ceb](https://github.com/bhardwajRahul/emailengine/commit/e337cebfb813192c385687c510c9e189d3eb0854))
* Add check-bounce CLI command for analyzing bounce emails ([ae3a85d](https://github.com/bhardwajRahul/emailengine/commit/ae3a85dd5acdf9c893196284487e536ac3d6d9ec))
* add configurable batch sizes for Gmail/Outlook exports ([a4d178c](https://github.com/bhardwajRahul/emailengine/commit/a4d178ceee195825d7f05a263897a873c361b296))
...
* Add dedicated page to view accounts assigned to IMAP worker threads ([6d7e69e](https://github.com/bhardwajRahul/emailengine/commit/6d7e69e35230a3a11076d65174ef1ed7e0ecc144))
...
* Add Exim-style bounce detection for diagnostic messages ([b82e588](https://github.com/bhardwajRahul/emailengine/commit/b82e588d3e699f3c757c6a01f3fb9933c94bbb4c))
* add export beta notice and status indicator in UI ([271bd18](https://github.com/bhardwajRahul/emailengine/commit/271bd1899241903c50f582827e0f08306c79cb1d))
* add export reliability improvements and resume capability ([9f78644](https://github.com/bhardwajRahul/emailengine/commit/9f78644cc1801bf64725bbde47c0910aab69769b))
* add export UI to admin account page ([cf3ce49](https://github.com/bhardwajRahul/emailengine/commit/cf3ce4979b6a4547081c2bea534a7327ebe73009))
* add global concurrent export limit and performance optimizations ([20a1272](https://github.com/bhardwajRahul/emailengine/commit/20a1272ca20ee9961c5163a0c5d8c5452cb6b556))
...
* add include attachments option to export UI ([2b8d2c6](https://github.com/bhardwajRahul/emailengine/commit/2b8d2c6cd60eb72556a1f1a4db03abf0cdc14e6f))
...
* Add MS Graph webhook subscription state metrics ([3e3ad18](https://github.com/bhardwajRahul/emailengine/commit/3e3ad184d013770d6defbe71f21072969fe105be))
* Add OAuth2 API metrics for MS Graph and Gmail backends ([9a8182c](https://github.com/bhardwajRahul/emailengine/commit/9a8182cf82c1493e472573b97dded8660feaff7f))
...
* Add OAuth2 token refresh metrics to all refresh paths ([4c23c90](https://github.com/bhardwajRahul/emailengine/commit/4c23c903edf916367ffc3bcd1b1abe97cf783bc6))
...
* add parallel message fetching for Gmail/Outlook export ([12de963](https://github.com/bhardwajRahul/emailengine/commit/12de963abe8f6922a8840e8291e57a5dcf03e584))
...
* Add Prometheus metrics and Grafana dashboard ([e3d4088](https://github.com/bhardwajRahul/emailengine/commit/e3d4088751ab0d04ea86425bbcea02ca49afbc90))
* Add support for Gmail send-only accounts ([#554](https://github.com/bhardwajRahul/emailengine/issues/554)) ([47fb593](https://github.com/bhardwajRahul/emailengine/commit/47fb593cfe390f066bd99ff84257abb036782d64))
* Add support for Outlook send-only accounts ([6b63ee4](https://github.com/bhardwajRahul/emailengine/commit/6b63ee4dff1feff087ab65e6233317cae8a4aad7))
...
* **api:** Add mailbox subscription management to modify endpoint ([4578c8a](https://github.com/bhardwajRahul/emailengine/commit/4578c8a89f56725ec02a3d9e2418c141acea4db1))
...
* display export expiration date in UI ([5e1e633](https://github.com/bhardwajRahul/emailengine/commit/5e1e6334e13b3b1ff012bfd76b933548c6cb6d83))
* expose outlookSubscription in account info API ([0d97b51](https://github.com/bhardwajRahul/emailengine/commit/0d97b51bd60458ad7a8cdd9170aa50605fd1c127))
...
* Improve ARF complaint detection and add comprehensive tests ([5533552](https://github.com/bhardwajRahul/emailengine/commit/55335526a19c6948675d126d1dbb14db353253a0))
* Improve autoreply detection and add comprehensive tests ([1cf179f](https://github.com/bhardwajRahul/emailengine/commit/1cf179f8289eb05e8add420fe02d6410f61718cc))
* Improve bounce detection coverage for non-standard formats ([5393872](https://github.com/bhardwajRahul/emailengine/commit/53938724c699b32177ece83c3d88be9a5432c067))
* Improve bounce detection for legacy formats ([90a0289](https://github.com/bhardwajRahul/emailengine/commit/90a0289f7999e23149e14ff6ea5d703de056d5b0))
...
* **outlook:** Add MS Graph API category support via labels API ([7de3586](https://github.com/bhardwajRahul/emailengine/commit/7de35863d4922ebd4fde4a2e448649a29bfc00b3))
* **outlook:** Add optional structured format for MS Graph sendMail ([5062e84](https://github.com/bhardwajRahul/emailengine/commit/5062e845fe29f16cdb7cce23b767657e1b283dfb))
...
* Replace static help.txt with dynamic CLI help system ([4cd5fb0](https://github.com/bhardwajRahul/emailengine/commit/4cd5fb059c2bf7436c4262a7daee1e85f535c322))
...
* accept base64-encoded nonces for backward compatibility ([2c46822](https://github.com/bhardwajRahul/emailengine/commit/2c46822a46ce1b2dc632f9a20f5831eabad3b623))
...
* add BullMQ stalled job configuration to prevent queue hangs ([23a74c3](https://github.com/bhardwajRahul/emailengine/commit/23a74c359e131baafd12dcf08d213eac0d96840f))
* Add EENGINE_DISABLE_SETUP_WARNINGS environment variable ([933a4f7](https://github.com/bhardwajRahul/emailengine/commit/933a4f7c8935f1aeadab5b65c6454460e6e191d5))
* Add EENGINE_ENABLE_OAUTH_TOKENS_API environment variable support ([be74bf9](https://github.com/bhardwajRahul/emailengine/commit/be74bf9b92ea20b9f0cbb7cf336036e4c2e5cf7b))
* Add environment variable support and deprecate unused OAuth2 fields ([a63fa8b](https://github.com/bhardwajRahul/emailengine/commit/a63fa8b93073b325422d7ed4ea034e4d53ad2b2b))
* add error logging for MS Graph subscription creation failures ([ba928e4](https://github.com/bhardwajRahul/emailengine/commit/ba928e495acb7fcc8c18e6cf34c917a2f4ad3337))
* add forced exit to prevent test timeout in CI ([aeb7261](https://github.com/bhardwajRahul/emailengine/commit/aeb726169b26e7263acb55041112f5a97a818b8a))
...
* add labels to remaining Joi schemas for stable OpenAPI names ([4e7e064](https://github.com/bhardwajRahul/emailengine/commit/4e7e064063f9e882ec94ada9d0dd1aad6567c675))
...
* add null guards to prevent unhandled exceptions ([9f48f64](https://github.com/bhardwajRahul/emailengine/commit/9f48f64b4ded00afa819d06d85be469ef4ea3ab6))
* Add retry logic for transient errors when fetching referenced messages ([9312f4b](https://github.com/bhardwajRahul/emailengine/commit/9312f4bcc95b2423e4bd98e3eeef1230aa02fcb9))
* address 14 bugs found since v2.61.5 ([839ce55](https://github.com/bhardwajRahul/emailengine/commit/839ce55502d28a23f86868012a51bd0077b31f65))
* address 5 release blockers for export and account APIs ([762c201](https://github.com/bhardwajRahul/emailengine/commit/762c20112e9b4de705f037659702eca18b750092))
* address 6 critical/high bugs and make export limits opt-in ([eb14c69](https://github.com/bhardwajRahul/emailengine/commit/eb14c69db2fad7c6fe8fd140de24c41f26922f48))
* address critical, high, and medium export feature issues ([576345a](https://github.com/bhardwajRahul/emailengine/commit/576345ad82d30193a13eea1ea130bf711cfae483))
* address must-fix and should-fix issues for release ([6def6ef](https://github.com/bhardwajRahul/emailengine/commit/6def6efc809e204fc39bd1bf6181a477fae0481f))
* address verified warnings from release review ([bb08f54](https://github.com/bhardwajRahul/emailengine/commit/bb08f54c2aba248e4204b704a6730c8bdf1eeb0e))
* **AI:** Add GPT-5 support with updated token limits ([f99947a](https://github.com/bhardwajRahul/emailengine/commit/f99947a34ff25ad0224c1b8e828d7cf104fd26a5))
...
* **attachments:** Bumped Nodemailer for fix issue with large data-uri images in emails ([64a498c](https://github.com/bhardwajRahul/emailengine/commit/64a498cccc8123958761c99e33164849378f2d07))
* **attachments:** Bumped Nodemailer for fix issue with large data-uri images in emails ([44cd002](https://github.com/bhardwajRahul/emailengine/commit/44cd002933635435626739e395bfdf8ba9679be2))
...
* Bumped dependencies to get rid of security warnings ([54b13c4](https://github.com/bhardwajRahul/emailengine/commit/54b13c4c4a42c7af886c63a97b6cdbb4dc8696b1))
* Bumped email-text-tools to fix webSafe processing ([ae6f2f1](https://github.com/bhardwajRahul/emailengine/commit/ae6f2f149ab675faaa9de5490809400b5c24996d))
...
* Correct API schema documentation and descriptions ([8a51465](https://github.com/bhardwajRahul/emailengine/commit/8a514650c8422b666244164aa71fe1d7b6f0ec2b))
* Correct CPU usage chart unit from seconds to dimensionless ([88765bc](https://github.com/bhardwajRahul/emailengine/commit/88765bc137a6dedafdaee8c6677b5e4e8ef2eec6))
* Correct OpenAPI response schema and add Docker CLI support ([38d39d6](https://github.com/bhardwajRahul/emailengine/commit/38d39d615d7e268261f4d8b49a7e79a943d9c553))
...
* Correct y-positions of Redis panels in Grafana dashboard ([12fdeff](https://github.com/bhardwajRahul/emailengine/commit/12fdeff1c4f837e7c37ebdb6c5647b01fb49c467))
...
* Detect "Out of the Office" autoreply subject pattern ([7191c50](https://github.com/bhardwajRahul/emailengine/commit/7191c50ae62930a66bf6598cb55f94130e022cf9))
...
* downgrade transient connection/timeout error logs to warn level ([9064529](https://github.com/bhardwajRahul/emailengine/commit/9064529a0d21cd6198386c73d9abca3447f6dc31))
* downgrade transient PubSub poll errors from error to warn ([d9f2e2f](https://github.com/bhardwajRahul/emailengine/commit/d9f2e2f6300b7e99a9ae57c6466fe147614bb891))
...
* Enable NPM package publishing ([051f4d6](https://github.com/bhardwajRahul/emailengine/commit/051f4d638ccea94f22d08924e300fa8672b51d9d))
* enrich OAuth token error messages for BullMQ job visibility ([29da53f](https://github.com/bhardwajRahul/emailengine/commit/29da53ff38c12e59b54468f5be3579c758a651c0))
* Ensure mailbox ID persistence during flush ([bb26992](https://github.com/bhardwajRahul/emailengine/commit/bb26992f110e640fa0f98f64dd714a20ac35c085))
* Exclude browser-only deps from pkg bundle ([994dd41](https://github.com/bhardwajRahul/emailengine/commit/994dd4169c5324d411feed804f277de119854916))
...
* Fix OAuth2 token refresh metrics not being recorded ([a6bf696](https://github.com/bhardwajRahul/emailengine/commit/a6bf6964e5b412bde5b44630eb20a3af59d2e700))
...
* Fixed build ([ac5d3b4](https://github.com/bhardwajRahul/emailengine/commit/ac5d3b4b700752e42acd0b7028bfdf622eac1f0a))
...
* force Swagger UI to light mode only ([4c26d12](https://github.com/bhardwajRahul/emailengine/commit/4c26d12437feaacd26da88a6fb3e85a7ca2ee238))
...
* **gmail:** Exclude OpenID scopes from service account authentication ([faf7821](https://github.com/bhardwajRahul/emailengine/commit/faf7821ddac184ba481c9acc9f0a38d2baaf834c))
* guard against null job in export worker BullMQ failed handler ([4cb1532](https://github.com/bhardwajRahul/emailengine/commit/4cb15324b913b7a8fbcbf4f5714c26e3c06226b3))
...
* handle delegation errors in loadAccountData, isApiClient, and UI listing ([c306618](https://github.com/bhardwajRahul/emailengine/commit/c306618a37428bbf088ed1289bf832e778f14b9c))
* handle empty or invalid JSON responses from OAuth APIs ([57d8886](https://github.com/bhardwajRahul/emailengine/commit/57d8886a0d29b20df4b575bac8210f6ed97f7fa3))
* handle missing attachments in ARF detection ([fe08f6a](https://github.com/bhardwajRahul/emailengine/commit/fe08f6a8c3120a01e04860c5770f78e925678797))
* handle missing attachments in Outlook message conversion ([46cf25a](https://github.com/bhardwajRahul/emailengine/commit/46cf25adefa9ca615f05381e257ee13a6c3e49b9))
* handle non-iterable messageInfo.attachments in mailbox sync ([3187571](https://github.com/bhardwajRahul/emailengine/commit/31875714e0ceb8e8711c910f6c561e1b1fe81a50))
...
* handle notificationBaseUrl without trailing slash in prepareUrl ([1048818](https://github.com/bhardwajRahul/emailengine/commit/1048818fe1b1a193a8d5f1b99a37285b54bd9317))
...
* handle uncaught EPIPE in ResponseStream for SSE endpoints ([ca7af4a](https://github.com/bhardwajRahul/emailengine/commit/ca7af4ad7a4fa6ccc02dcaee79f06d33bd38e8b8))
...
* Harden bounce detection against edge cases and ReDoS attacks ([d6c72c2](https://github.com/bhardwajRahul/emailengine/commit/d6c72c29d4c2bc1a20025204cc0cf20f803b04a6))
...
* harden OAuth token request body serialization and error handling ([296c4e9](https://github.com/bhardwajRahul/emailengine/commit/296c4e99fd00928fa0682f2c735c2d81c1a74bcf))
...
* Improve auth-server example with proper error handling and documentation ([cef5b47](https://github.com/bhardwajRahul/emailengine/commit/cef5b47378bdb18a1ff136fd29e8c63dd566cb86))
* improve BullMQ efficiency with jitter, retention, and cleanup ([fb48fd8](https://github.com/bhardwajRahul/emailengine/commit/fb48fd84065fe44a4bf5054ced45f4bffc9c8153))
* Improve OAuth token refresh error handling and state management ([5be242b](https://github.com/bhardwajRahul/emailengine/commit/5be242bd5392ff08f83d7709ad4f82f8f218e05d))
* improve packUid robustness with fallback and validation ([4b4253e](https://github.com/bhardwajRahul/emailengine/commit/4b4253e3fd025070b42c3d012071dd6376191692))
* improve submit resilience during worker restarts and add batch endpoint ([f559c38](https://github.com/bhardwajRahul/emailengine/commit/f559c3818bb727b137f5a2b8b32b0efee48a093d))
...
* Increase openAiPrompt max size from 6KB to 1MB ([29d673d](https://github.com/bhardwajRahul/emailengine/commit/29d673d6bf35f78c3ef53ec1b690c49deecd889c))
...
* leverage Nodemailer error codes for better retry logic and UI messages ([0f3068a](https://github.com/bhardwajRahul/emailengine/commit/0f3068abc4b63d87a9f93ba927f8be07a5737f0c))
...
* **LLM integration:** Add configurable max tokens setting for OpenAI API ([a746388](https://github.com/bhardwajRahul/emailengine/commit/a746388c0b69746f21f6ac95e49d7797bb8f9722))
...
* Memory leak fixes for IMAP client and webhooks worker ([b749f96](https://github.com/bhardwajRahul/emailengine/commit/b749f964f7e8de6828d23b8c3c5a3ca11e15898a))
...
* **outlook:** Improve delegated user handling and add clarifying comments ([cef7d25](https://github.com/bhardwajRahul/emailengine/commit/cef7d25fe1726e029181566622e156309c800f8a))
* **outlook:** Preserve calendar invite functionality when sending via Graph API ([92bd7f8](https://github.com/bhardwajRahul/emailengine/commit/92bd7f89c93e5998da400986fe698aff9c4d7fc0))
* **outlook:** Request specific body content type from MS Graph API ([9428852](https://github.com/bhardwajRahul/emailengine/commit/9428852c6f79721c9422698de25edc8ba9cfec8d))
* **outlook:** Use structured message format for Graph API sendMail to respect from field ([c1bf874](https://github.com/bhardwajRahul/emailengine/commit/c1bf8745fc0ceb0013428065a1dcb932781ae3de))
...
* preserve threadId for large Gmail threaded replies via multipart upload ([b04c2ca](https://github.com/bhardwajRahul/emailengine/commit/b04c2cac6bc7a6dfe347a800b57ed0bd1a21291a))
* prevent 500 error when listing accounts with invalid delegation config ([8651bcc](https://github.com/bhardwajRahul/emailengine/commit/8651bcc3c18cd54ee5309b3392915773c355e6c4))
* prevent ArrayBuffer detachment and IMAP null reference errors ([3b97372](https://github.com/bhardwajRahul/emailengine/commit/3b9737234b6f71ae9c1adbf4018134cc6bb4a070))
* prevent concurrent export race condition with atomic Redis operation ([dbc14f6](https://github.com/bhardwajRahul/emailengine/commit/dbc14f683ef8509003699a12ff60ec26001522fa))
...
* prevent sync state corruption from invalid uidNext values ([533f026](https://github.com/bhardwajRahul/emailengine/commit/533f026933fbbefb8b6998e412dc8cf3693c2b9b))
* prevent sync state corruption from invalid uidValidity values ([976fdb7](https://github.com/bhardwajRahul/emailengine/commit/976fdb7a1a74127c6c738b331f2c5aa8b7daddb4))
...
* prevent UTF-8 data corruption in OAuth request Buffer handling ([14361fd](https://github.com/bhardwajRahul/emailengine/commit/14361fdc4c7c04ad2ca5934eb4d418abf1c66289))
* race condition in runFullSync and add diagnostic logging ([#549](https://github.com/bhardwajRahul/emailengine/issues/549)) ([cdb3fe1](https://github.com/bhardwajRahul/emailengine/commit/cdb3fe18b2494cc02f1e50e98ffddf0003329dd2))
...
* Reduce production node_modules size by removing unused static-only deps ([af9d584](https://github.com/bhardwajRahul/emailengine/commit/af9d584d4ad806e8a0b9eb7e59e6d5c8c8ff8878))
...
* reject invalid nonce format instead of silently regenerating ([422ea5c](https://github.com/bhardwajRahul/emailengine/commit/422ea5c3dc56f4cf1679a1783d4c108d1486f455))
...
* remove BullMQ job when marking interrupted exports as failed ([ad587a7](https://github.com/bhardwajRahul/emailengine/commit/ad587a7e0e536f2cb1647f420daa338e24d24233))
...
* Rename IMAP worker to Email worker in thread display ([95b39da](https://github.com/bhardwajRahul/emailengine/commit/95b39da07c7ee28ac0539f6599546bc49af8e0ac))
...
* replace blocking scryptSync with async scrypt in DecryptStream ([c9c6ede](https://github.com/bhardwajRahul/emailengine/commit/c9c6edefb11bf7908e5fd64118ff4211f5f6bd4e))
...
* resolve 11 bugs in export functionality ([f5d2621](https://github.com/bhardwajRahul/emailengine/commit/f5d2621bbaa2cf3b1dab06c67a7e2d5bf29075ed))
...
* resolve Gmail label IDs to human-readable names ([02c306f](https://github.com/bhardwajRahul/emailengine/commit/02c306f10f29d8941f242f9283684621fefcd5c3))
...
* resolve OpenAPI spec validation errors for token restrictions ([a9cffe1](https://github.com/bhardwajRahul/emailengine/commit/a9cffe150843fb7f8b4f7f5d01afc69ef451bac2))
...
* restore retry for empty Buffer payloads and fix large threaded Gmail replies ([107c164](https://github.com/bhardwajRahul/emailengine/commit/107c16475a2278a9428903d7280f481cf62a64ec))
...
* return WorkerNotAvailable immediately and remove batch submit endpoint ([aed5c45](https://github.com/bhardwajRahul/emailengine/commit/aed5c45aeec37a42b6c7113a3e45cb7153ae67bb))
* revert jQuery to 3.7.1 and harden export resilience ([43f2a74](https://github.com/bhardwajRahul/emailengine/commit/43f2a74587fc8915dbb6dce6497f60a8159f6140))
...
* send Buffer for Outlook sendMail base64 payload to avoid JSON quoting ([e89a924](https://github.com/bhardwajRahul/emailengine/commit/e89a924343bf8ba3ea1fd7e75bc09aa53c2177b2))
...
* share Lock instance across Account objects to prevent Redis connection leak ([56f421b](https://github.com/bhardwajRahul/emailengine/commit/56f421b866a12187937cfa935764878f14f0ab1b))
* show Failed status for accounts with IMAP disabled due to auth errors ([e6b687d](https://github.com/bhardwajRahul/emailengine/commit/e6b687d458cfd080795f7176f862109e2c299fff))
...
* **smtp-interface:** Add configurable SMTP message size limit ([c3692b9](https://github.com/bhardwajRahul/emailengine/commit/c3692b929fded1f48f1054da1777a19378908b0f))
* stabilize Swagger model names for SDK generation ([8078830](https://github.com/bhardwajRahul/emailengine/commit/80788305f23eee9d021b4c72dce21961493ca093))
...
* tighten export route validation and apply default export limits ([f45d83f](https://github.com/bhardwajRahul/emailengine/commit/f45d83f1d27ab05984f1a0213174025f5f79d71e))
...
* update gettext script to include refactored UI route files ([5b2e4a5](https://github.com/bhardwajRahul/emailengine/commit/5b2e4a55771f192fb14d030b5e5d08ba860c90ab))
...
* update test expectations for email-text-tools 2.3.5+ behavior ([1e28abf](https://github.com/bhardwajRahul/emailengine/commit/1e28abf77282ac4c550f9834f61064ae8fde7de9))
* update test expectations for email-text-tools 2.4.x ([6333fa3](https://github.com/bhardwajRahul/emailengine/commit/6333fa3308b1b822a5c364ad5cb25c1c211edeca))
...
* use base64url encoding for OAuth state nonce in /v1/authentication/form ([1f2cecf](https://github.com/bhardwajRahul/emailengine/commit/1f2cecf9efbee8a12c3a0d27c9879bfbbf7dfa39))
* use base64url encoding for OAuth state nonce in /v1/authentication/form ([dead38c](https://github.com/bhardwajRahul/emailengine/commit/dead38c348f1c0204f2bfba09997090cb86c348b))
* use base64url encoding for OAuth state nonce in remaining locations ([961b710](https://github.com/bhardwajRahul/emailengine/commit/961b710357d836782c9bbce329178aa96e08ee20))
* use consistent index source in batch submit success and failure paths ([3a73704](https://github.com/bhardwajRahul/emailengine/commit/3a737047c1f1e4fda6bd7c4b6822ca31ebe27fd2))
...
* validate nonce format before using data.n from cached URLs ([d825303](https://github.com/bhardwajRahul/emailengine/commit/d82530395e93e88f5841156a53fe41d476eec9da))
* Wrap async close handler await calls in try-catch to prevent unhandled rejections ([c6df321](https://github.com/bhardwajRahul/emailengine/commit/c6df321c7a580c1cd10d2e1eac5681aa49e4c87a))
...
* use MS Graph batch API for Outlook message export ([f031f77](https://github.com/bhardwajRahul/emailengine/commit/f031f770278a14aeb2fd5a589e31bb5621b0c410))


### Reverts

* remove Swagger UI light mode forcing ([9c9bd25](https://github.com/bhardwajRahul/emailengine/commit/9c9bd25e4488828e3112e671df12d1c551957dac))
